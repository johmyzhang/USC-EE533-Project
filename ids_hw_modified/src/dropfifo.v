...
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/lab3_v3/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_6 (.A(XLXN_25[7:0]), 
                                  .B(XLXN_27[7:0]), 
                                  .EQ(XLXN_17));
   // synthesis attribute HU_SET of XLXI_6 is "XLXI_6_20"
   COMP8_MXILINX_dropfifo XLXI_7 (.A(XLXN_27[7:0]), 
                                  .B(XLXN_21[7:0]), 
                                  .EQ(XLXN_37));
   ...
   reg9B XLXI_11 (.ce(XLXN_10), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_32[71:0]));
   dp_9b_mem XLXI_12 (.addra(XLXN_25[7:0]), 
                      .addrb(XLXN_27[7:0]), 
                      .clka(clk), 
                      .clkb(clk), 
                      .dina(XLXN_32[71:0]), 
                      .wea(XLXN_43), 
                      .doutb(out_fifo[71:0]));
   OR2 XLXI_13 (.I0(XLXN_19), 
                .I1(XLXN_18), 
                .O(XLXN_20));
   AND2B1 XLXI_14 (.I0(XLXN_26), 
                   .I1(XLXN_20), 
                   .O(XLXN_24));
